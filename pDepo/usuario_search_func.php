...
function art_form_searchdata_display($form, $message){
    ...
    art_sitemenu_display("usuario_search", "defaulttheme");
    print "</td>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"nombre\" name=\"nombre\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"45\" >\n";
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_cedula;
    if (($value == "") || ($value == null)) {
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"cedula\" name=\"cedula\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"45\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"tipo_usuario\" name=\"tipo_usuario\" type=\"text\" value=\"" . $value . "\"  size=\"25\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"reporte\" name=\"reporte\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"16777215\" >\n";
    print "</td>\n";
    print "</tr>\n";
    print "	              <tr>\n";
...
function art_search_data(){
    ...
    $fld_name[] = "usuario.nombre";
    $fld_type[] = 1;
	  $fld_value[] = art_request("nombre", "");
    $fld_name[] = "usuario.cedula";
    $fld_type[] = 1;
	  $fld_value[] = art_request("cedula", "");
    $fld_name[] = "usuario.tipo_usuario";
    $fld_type[] = 4;
	  $fld_value[] = art_request("tipo_usuario", "");
    $fld_name[] = "usuario.fecha_creacion";
    $fld_type[] = 3;
    $artv_fecha_creacion_year = art_request("fecha_creacion_year", "");
    $artv_fecha_creacion_month = art_request("fecha_creacion_month", "");
    $artv_fecha_creacion_day = art_request("fecha_creacion_day", "");
    ...
    $fld_name[] = "usuario.reporte";
    $fld_type[] = 1;
	  $fld_value[] = art_request("reporte", "");
    ...
    if ($result == "") {
        ...
        for ($i=0; $i<$icount; $i++) {
            ...
            if ($sql_where == "") {
		        ...
		        art_set_session('usuario_search', $sql_where);
