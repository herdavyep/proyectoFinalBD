...
function art_form_deletedata_display($form, $message){
    ...
    $artv_fecha_creacion =  art_format_date( art_rowdata($row, 4) , "m/d/Y") ;
    ...
    art_sitemenu_display("usuario_delete", "defaulttheme");
    print "</td>\n";
    ...
    print "</td>\n";
    print "</tr>\n";
    $svalue = art_check_null($artv_tipo_usuario);
    if ($svalue != "&nbsp;"){
        $svalue = htmlspecialchars($svalue);
    }
    print "<tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<label id=\"tipo_usuario\" name=\"tipo_usuario\" >" . $svalue . "</label>\n";
    print"<input id=\"lbhd_tipo_usuario\" name=\"lbhd_tipo_usuario\" type=\"hidden\" value=\"" . $svalue . "\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "</td>\n";
    print "</tr>\n";
    $svalue = art_check_null($artv_reporte);
    if ($svalue != "&nbsp;"){
        $svalue = htmlspecialchars($svalue);
    }
    print "<tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<label id=\"reporte\" name=\"reporte\" >" . $svalue . "</label>\n";
    print"<input id=\"lbhd_reporte\" name=\"lbhd_reporte\" type=\"hidden\" value=\"" . $svalue . "\" >\n";
    print "</td>\n";
    print "</tr>\n";
    print "	                  <tr>\n";
