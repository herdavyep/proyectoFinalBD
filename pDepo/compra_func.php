...
function art_datagrid_display($field_names, $page_size, $current_page, $quick_search, $navtype, $category, $showtotalrec=0, $showpagesize=0) {	
    ...
    $qrystr = array_fill(0, 12, "");
    $clr = art_request("clr_compra", "");
    $clr_adv_session = art_request("clr_compra_adv_session", "");

    if (strtolower($clr) == "t"){
        art_clear_session("compra_sort1");	
        art_clear_session("compra_sort2");	
        art_clear_session("compra_sort3");	
        art_clear_session("compra_sort4");	
        art_clear_session("compra_sort5");	
        art_clear_session("compra_sort6");	
        art_clear_session("compra_sort7");	
        art_clear_session("compra_sort8");	
        art_clear_session("compra_sort9");	
        art_clear_session("compra_sort10");	
        art_clear_session("compra_sort11");	
        art_clear_session("compra_sort12");	
        $clr = "";
	  }

    if (strtolower($clr_adv_session) == "y") {
        $clr_adv_session = "";
        art_clear_session("compra_search");
        art_clear_session("compra_page");
        art_clear_session("compra_quick_search");
        art_clear_session("compra_category");
        $quick_search = "";
        $category = "";
	  }

    art_assign_session("compra_sort1", "");
    art_assign_session("compra_sort2", "");
    art_assign_session("compra_sort3", "");
    art_assign_session("compra_sort4", "");
    art_assign_session("compra_sort5", "");
    art_assign_session("compra_sort6", "");
    art_assign_session("compra_sort7", "");
    art_assign_session("compra_sort8", "");
    art_assign_session("compra_sort9", "");
    art_assign_session("compra_sort10", "");
    art_assign_session("compra_sort11", "");
    art_assign_session("compra_sort12", "");
    art_assign_session("compra_page_size", 20);
    art_assign_session("compra_page", "1");
    $sql_array  = art_split_sql(" select * from `compra`"); 
    $sql_start = $sql_array[0]; 
    $sql_orderby = $sql_array[1]; 
    $sort1 = art_session("compra_sort1", "");
    $sort2 = art_session("compra_sort2", "");
    $sort3 = art_session("compra_sort3", "");
    $sort4 = art_session("compra_sort4", "");
    $sort5 = art_session("compra_sort5", "");
    $sort6 = art_session("compra_sort6", "");
    $sort7 = art_session("compra_sort7", "");
    $sort8 = art_session("compra_sort8", "");
    $sort9 = art_session("compra_sort9", "");
    $sort10 = art_session("compra_sort10", "");
    $sort11 = art_session("compra_sort11", "");
    $sort12 = art_session("compra_sort12", "");
    ...
    for ($i=1; $i<=12; $i++){
        $sorting = "";
        $sort_order = "";
        if (art_session("compra_sort".$i, "") == "1"){
            $sorting = "&compra_sort". $i . "=" . "2";
            $sort_order = "ASC";
        } else if (art_session("compra_sort".$i, "") == "2"){
            $sorting = "&compra_sort". $i . "=" . "1";
            $sort_order = "DESC";
        } else {
            $sorting = "&compra_sort". $i . "=" . "1";
            $sort_order = "";
        }
        $qrystr[$i] = "compra_ajax.php?clr_compra=t".$sorting;
    ...
    $advsearch_sql = art_session("compra_search","");
    if ($advsearch_sql != "") {
    ...
    art_sitemenu_display("compra", "defaulttheme");
    print "</td>\n";
    ...
    print "                    <td class=\"gridHeaderBG\" colspan=\"12\">\n";
    ...
    print "<a href=\"" . art_gen_url("compra_ajax.php?clr_compra_adv_session=y", 1). "\"" . " title=\"Show All\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/show_all.gif\" border=\"0\" /></a>";
    print "&nbsp;<a href=\"" . art_gen_url("compra_ajax.php?clr_compra=t", 1). "\"" . " title=\"Clear Sort\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/clear_sort.gif\" border=\"0\" /></a>";
    print "&nbsp;<a href=\"" . "./compra_search.php". "\"" . " title=\"Advance Search\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/adv_search.gif\" border=\"0\" /></a>";
    print "&nbsp;<a href=\"" . "./compra_add.php". "\"" . " title=\"Add New Record\" class=\"gridToolBarLink\"><img src=\"./images/defaultbutton/add.gif\" border=\"0\" /></a>";
    print "&nbsp;";
    print "                                </td>\n";
    print "                            </tr>\n";
    print "                        </table>\n";
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[2], 1) . "\" class=\"gridColumnLink\">Fecha Creacion</a>\n";
    if ($sort2 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[3], 1) . "\" class=\"gridColumnLink\">Kilos</a>\n";
    if ($sort3 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[4], 1) . "\" class=\"gridColumnLink\">Arrobas</a>\n";
    if ($sort4 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[5], 1) . "\" class=\"gridColumnLink\">Precio</a>\n";
    if ($sort5 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[6], 1) . "\" class=\"gridColumnLink\">Total</a>\n";
    if ($sort6 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[7], 1) . "\" class=\"gridColumnLink\">Bultos</a>\n";
    if ($sort7 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[8], 1) . "\" class=\"gridColumnLink\">Clientes Id</a>\n";
    if ($sort8 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[9], 1) . "\" class=\"gridColumnLink\">Calidad Id</a>\n";
    if ($sort9 == "1") {
    ...
    print "                    <td class=\"gridColumn\"  NOWRAP >\n";
    print "                        <div class=\"gridColumnText\">\n";
    print "                            <a href=\"" . art_gen_url($qrystr[10], 1) . "\" class=\"gridColumnLink\">Usuario Id</a>\n";
    if ($sort10 == "1") {
    ...
    if ( ($numrows > 0) && ($result) ) {
        ...
        while ($row = mysql_fetch_array($result)){ 
            ...
            print "</td>\n";
            print "<td align=\"left\" >";
            $svalue = art_check_null( art_format_date( art_rowdata($row, 1) , "m/d/Y") );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 2) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 3) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 4) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 5) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 6) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 7) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 8) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            print "</td>\n";
            print "<td align=\"right\" >";
            $svalue = art_check_null( number_format( art_rowdata($row, 9) , 2, '.', ',' ) );
            if ($svalue != "&nbsp;"){
                $svalue = htmlspecialchars($svalue);
            }
            print $svalue;
            ...
            print "<a href=\"" . "./compra_edit.php". "?pm_calidad_id=" . art_rowdata_byname($row, $field_names, "compra.calidad_id"). "&pm_clientes_id=" . art_rowdata_byname($row, $field_names, "compra.clientes_id"). "&pm_id=" . art_rowdata_byname($row, $field_names, "compra.id"). "&pm_usuario_id=" . art_rowdata_byname($row, $field_names, "compra.usuario_id"). "\"" . " title=\"Edit\" target=\"_self\" class=\"gridBodyLink\">";
            ...
            print "</td>\n";
            print "<td align=\"center\" >";
            print "<a href=\"" . "./compra_delete.php". "?pm_calidad_id=" . art_rowdata_byname($row, $field_names, "compra.calidad_id"). "&pm_clientes_id=" . art_rowdata_byname($row, $field_names, "compra.clientes_id"). "&pm_id=" . art_rowdata_byname($row, $field_names, "compra.id"). "&pm_usuario_id=" . art_rowdata_byname($row, $field_names, "compra.usuario_id"). "\"" . " title=\"Delete\" target=\"_self\" class=\"gridBodyLink\">";
        ...
        print "                    <td colspan=\"12\" ><div class=\"gridErrMsg\">" . $emptydatatext . "</div></td>\n";
        print "                </tr>\n";
    }
    print "            </table>\n";
    ...
    print "                    <td class=\"gridFooterBG\" colspan=\"12\">\n";
    if ( ($numrows > 0) && ($result) ){
        ...
        if ($navtype != ""){
            $pagename = "compra";
            art_show_navigator($pagename, $navtype, $numrows, $page_size, $current_page, "compra_ajax.php", 1, 0, $use_ajax, $folder_button_images);
        }
    } else {
...
function del_selected_items($pagerecords) {
    ...
    for ($i=1; $i <= $pagerecords; $i++){
        ...
        if ($del_id != ""){
            $artv_pm_calidad_id = art_request("pm_calidad_id" . $i, "");
            $artv_pm_clientes_id = art_request("pm_clientes_id" . $i, "");
            $artv_pm_id = art_request("pm_id" . $i, "");
            $artv_pm_usuario_id = art_request("pm_usuario_id" . $i, "");
            if ($j==0){

                $sqlDel = "DELETE FROM `compra` WHERE ";
                $sqlDel .= "compra.calidad_id = " .  art_quote_intval($artv_pm_calidad_id);
                $sqlDel .= " AND compra.clientes_id = " .  art_quote_intval($artv_pm_clientes_id);
                $sqlDel .= " AND compra.id = " .  art_quote_intval($artv_pm_id);
                $sqlDel .= " AND compra.usuario_id = " .  art_quote_intval($artv_pm_usuario_id);
...
function art_groupdatagrid_display($field_names, $page_size, $current_page, $quick_search, $navtype, $category, $showtotalrec=0, $showpagesize=0) {	
    ...
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Kilos</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Arrobas</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Precio</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Total</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Bultos</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Clientes Id</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Calidad Id</div></td>\n";
    print "                    <td class=\"gridColumn\" ><div class=\"gridColumnText\">Usuario Id</div></td>\n";
    ...
    if ( ($numrows > 0) && ($result) ){
        ...
        while ($row = mysql_fetch_array($result)){ 
            ...
            if (strcmp($group, $currgroup) != 0){
                ...
                print "                <tr>\n"; 
                print "                    <td colspan=\"12\" class=\"groupCaption\">\n"; 
