...
function art_sitemenu_display($forpage, $cssname){
    ...
    print "             <ul>\n";
    if ($forpage == "calidad" ){
        print "                 <li class=\"siteMenuSelected\">calidad</li>\n";
    } else {
        print "                 <li><a href=\"" . "./calidad.php?clr_calidad=t&clr_calidad_adv_session=y". "\"" . " title=\"calidad\">calidad</a></li>\n";
    }
    if ($forpage == "clientes" ){
        print "                 <li class=\"siteMenuSelected\">clientes</li>\n";
    } else {
        print "                 <li><a href=\"" . "./clientes.php?clr_clientes=t&clr_clientes_adv_session=y". "\"" . " title=\"clientes\">clientes</a></li>\n";
    }
    if ($forpage == "compra" ){
        print "                 <li class=\"siteMenuSelected\">compra</li>\n";
    } else {
        print "                 <li><a href=\"" . "./compra.php?clr_compra=t&clr_compra_adv_session=y". "\"" . " title=\"compra\">compra</a></li>\n";
    }
    if ($forpage == "factura" ){
        print "                 <li class=\"siteMenuSelected\">factura</li>\n";
    } else {
        print "                 <li><a href=\"" . "./factura.php?clr_factura=t&clr_factura_adv_session=y". "\"" . " title=\"factura\">factura</a></li>\n";
    }
    if ($forpage == "temporal" ){
        print "                 <li class=\"siteMenuSelected\">temporal</li>\n";
    } else {
        print "                 <li><a href=\"" . "./temporal.php?clr_temporal=t&clr_temporal_adv_session=y". "\"" . " title=\"temporal\">temporal</a></li>\n";
    }
    if ($forpage == "usuario" ){
        print "                 <li class=\"siteMenuSelected\">usuario</li>\n";
    } else {
        print "                 <li><a href=\"" . "./usuario.php?clr_usuario=t&clr_usuario_adv_session=y". "\"" . " title=\"usuario\">usuario</a></li>\n";
    }
    print "             </ul>\n";
    print "             </div>\n";
    print "        </td>\n";
