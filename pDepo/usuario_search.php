...
require_once './usuario_search_func.php';
...
if (($artsv_postback == "1") && ($refresh_view != "1")){
	  ...
	  if ($err_string == "SUCCESS") {
        art_set_session("usuario_page", "1");
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <form name="art_form" id="art_form" method="post" action="usuario_search.php"  style="margin: 0px; padding: 0px;">
