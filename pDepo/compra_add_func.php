...
function art_form_insertdata_display($form, $message){
    ...
    art_sitemenu_display("compra_add", "defaulttheme");
    print "</td>\n";
...
function art_insert_data() {
    ...
    if (($result == "") && (art_session('art_form_loaded', 0) != 1)){
        ...
        $sql .= " (";
        $sql .= "compra.id"; 
        $sql .= ",compra.fecha_creacion"; 
        $sql .= ",compra.kilos"; 
        $sql .= ",compra.arrobas"; 
        $sql .= ",compra.precio"; 
        $sql .= ",compra.total"; 
        $sql .= ",compra.bultos"; 
        $sql .= ",compra.clientes_id"; 
        $sql .= ",compra.calidad_id"; 
        $sql .= ",compra.usuario_id"; 
        $sql .= ") ";
        $sql .= " VALUES "; 
        $sql .= " (";
        $sql .=  art_quote_intval($artv_id); 
        $sql .= " , " .  art_quote_dateval($artv_fecha_creacion); 
        $sql .= " , " .  art_quote_intval($artv_kilos); 
        $sql .= " , " .  art_quote_intval($artv_arrobas); 
        $sql .= " , " .  art_quote_intval($artv_precio); 
        $sql .= " , " .  art_quote_intval($artv_total); 
        $sql .= " , " .  art_quote_intval($artv_bultos); 
        $sql .= " , " .  art_quote_intval($artv_clientes_id); 
        $sql .= " , " .  art_quote_intval($artv_calidad_id); 
