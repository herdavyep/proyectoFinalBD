...
function art_form_searchdata_display($form, $message){
    ...
    art_sitemenu_display("factura_search", "defaulttheme");
    print "</td>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"valor\" name=\"valor\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"12\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_temporal_id;
    if (($value == "") || ($value == null)) {
        $value = "";
        $artv_temporal_id = $value;
    }
    $artsv_postback = art_request("artsys_postback", "");
    if (($artsv_postback == null) || ($artsv_postback == "")){
        $value = "";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"temporal_id\" name=\"temporal_id\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
...
function art_search_data(){
    ...
    $fld_name[] = "factura.valor";
    $fld_type[] = 2;
	  $fld_value[] = art_request("valor", "");
    $fld_name[] = "factura.fecha_creacion";
    $fld_type[] = 3;
    $artv_fecha_creacion_year = art_request("fecha_creacion_year", "");
    $artv_fecha_creacion_month = art_request("fecha_creacion_month", "");
    $artv_fecha_creacion_day = art_request("fecha_creacion_day", "");
    ...
    $fld_name[] = "factura.temporal_id";
    $fld_type[] = 2;
	  $fld_value[] = art_request("temporal_id", "");
    $fld_name[] = "factura.clientes_id";
    $fld_type[] = 2;
	  $fld_value[] = art_request("clientes_id", "");
    $fld_name[] = "factura.usuario_id";
    $fld_type[] = 2;
    ...
    if ($result == "") {
        ...
        for ($i=0; $i<$icount; $i++) {
            ...
            if ($sql_where == "") {
		        ...
		        art_set_session('factura_search', $sql_where);
