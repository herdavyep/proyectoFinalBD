...
function art_form_updatedata_display($form, $message){
    ...
    if (($aj != "1") && ($message == "")){
        ...
        $artv_fecha_creacion =  art_rowdata($row, 2) ;
    ...
    art_sitemenu_display("factura_edit", "defaulttheme");
    print "</td>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"valor\" name=\"valor\" type=\"text\" value=\"" . $value . "\"  size=\"12\" maxlength=\"12\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"temporal_id\" name=\"temporal_id\" type=\"text\" value=\"" . $value . "\"  size=\"10\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
...
function art_update_data(){
    ...
    if (($result == "") && (art_session('art_form_loaded', 0) != 1)){
        ...
        $sql .= " factura.valor = " .  art_quote_intval($artv_valor); 
        $sql .= ",factura.fecha_creacion = " .  art_quote_dateval($artv_fecha_creacion); 
        $sql .= ",factura.temporal_id = " .  art_quote_intval($artv_temporal_id); 
        $sql .= ",factura.clientes_id = " .  art_quote_intval($artv_clientes_id); 
        $sql .= ",factura.usuario_id = " .  art_quote_intval($artv_usuario_id); 
        $sql .= " WHERE ";
        $sql .= " factura.clientes_id = " .  art_quote_intval($artv_pm_clientes_id);
        $sql .= " AND  factura.id = " .  art_quote_intval($artv_pm_id);
        $sql .= " AND  factura.temporal_id = " .  art_quote_intval($artv_pm_temporal_id);
