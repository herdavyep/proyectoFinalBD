...
function art_form_searchdata_display($form, $message){
    ...
    art_sitemenu_display("compra_search", "defaulttheme");
    print "</td>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"kilos\" name=\"kilos\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"12\" >\n";
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_arrobas;
    if (($value == "") || ($value == null)) {
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"arrobas\" name=\"arrobas\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"12\" >\n";
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_precio;
    if (($value == "") || ($value == null)) {
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"precio\" name=\"precio\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"12\" >\n";
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_total;
    if (($value == "") || ($value == null)) {
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"total\" name=\"total\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"12\" >\n";
    print "</td>\n";
    print "</tr>\n";
    $value = $artv_bultos;
    if (($value == "") || ($value == null)) {
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"bultos\" name=\"bultos\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"clientes_id\" name=\"clientes_id\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"calidad_id\" name=\"calidad_id\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"usuario_id\" name=\"usuario_id\" type=\"text\" value=\"" . $value . "\"  size=\"25\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
    print "	              <tr>\n";
...
function art_search_data(){
    ...
    $fld_name[] = "compra.fecha_creacion";
    $fld_type[] = 3;
    $artv_fecha_creacion_year = art_request("fecha_creacion_year", "");
    $artv_fecha_creacion_month = art_request("fecha_creacion_month", "");
    $artv_fecha_creacion_day = art_request("fecha_creacion_day", "");
    ...
    $fld_name[] = "compra.kilos";
    $fld_type[] = 2;
	  $fld_value[] = art_request("kilos", "");
    $fld_name[] = "compra.arrobas";
    $fld_type[] = 2;
	  $fld_value[] = art_request("arrobas", "");
    $fld_name[] = "compra.precio";
    $fld_type[] = 2;
	  $fld_value[] = art_request("precio", "");
    $fld_name[] = "compra.total";
    $fld_type[] = 2;
	  $fld_value[] = art_request("total", "");
    $fld_name[] = "compra.bultos";
    $fld_type[] = 2;
	  $fld_value[] = art_request("bultos", "");
    $fld_name[] = "compra.clientes_id";
    $fld_type[] = 2;
	  $fld_value[] = art_request("clientes_id", "");
    $fld_name[] = "compra.calidad_id";
    $fld_type[] = 2;
	  $fld_value[] = art_request("calidad_id", "");
    $fld_name[] = "compra.usuario_id";
    $fld_type[] = 2;
	  $fld_value[] = art_request("usuario_id", "");
    ...
    if ($result == "") {
        ...
        for ($i=0; $i<$icount; $i++) {
            ...
            if ($sql_where == "") {
		        ...
		        art_set_session('compra_search', $sql_where);
