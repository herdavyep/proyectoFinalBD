...
require_once './clientes_edit_func.php';
...
<script language="javascript" type="text/javascript" src="components/calendar/basicgreen/jscalendar.js"></script>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            <td>
                <form name="art_form" id="art_form" method="post" action="clientes_edit.php"  style="margin: 0px; padding: 0px;">
