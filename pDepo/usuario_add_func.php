...
function art_form_insertdata_display($form, $message){
    ...
    art_sitemenu_display("usuario_add", "defaulttheme");
    print "</td>\n";
...
function art_insert_data() {
    ...
    if (($result == "") && (art_session('art_form_loaded', 0) != 1)){
        ...
        $sql .= ",usuario.nombre"; 
        $sql .= ",usuario.cedula"; 
        $sql .= ",usuario.tipo_usuario"; 
        $sql .= ",usuario.fecha_creacion"; 
        $sql .= ",usuario.reporte"; 
        $sql .= ") ";
        $sql .= " VALUES "; 
        $sql .= " (";
        ...
        $sql .= " , " .  art_quote_strval($artv_cedula); 
        $sql .= " , " .  art_quote_strval($artv_tipo_usuario); 
        $sql .= " , " .  art_quote_dateval($artv_fecha_creacion); 
        $sql .= " , " .  art_quote_strval($artv_reporte); 
       $sql .= ") ";
    }
