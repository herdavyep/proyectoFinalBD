...
function art_form_searchdata_display($form, $message){
    ...
    art_sitemenu_display("clientes_search", "defaulttheme");
    print "</td>\n";
...
function art_search_data(){
    ...
    $fld_name = array();
    $fld_value = array();
    $fld_name[] = "clientes.id";
    $fld_type[] = 2;
	  $fld_value[] = art_request("id", "");
    $fld_name[] = "clientes.nombre";
    $fld_type[] = 1;
	  $fld_value[] = art_request("nombre", "");
    $fld_name[] = "clientes.cedula";
    $fld_type[] = 1;
	  $fld_value[] = art_request("cedula", "");
    $fld_name[] = "clientes.fecha_creacion";
    $fld_type[] = 3;
    $artv_fecha_creacion_year = art_request("fecha_creacion_year", "");
    $artv_fecha_creacion_month = art_request("fecha_creacion_month", "");
    $artv_fecha_creacion_day = art_request("fecha_creacion_day", "");
    ...
    if ($result == "") {
        ...
        for ($i=0; $i<$icount; $i++) {
            ...
            if ($sql_where == "") {
		        ...
		        art_set_session('clientes_search', $sql_where);
