...
require_once './compra_search_func.php';
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        <td>
            <form name="art_form" id="art_form" method="post" action="compra_search.php"  style="margin: 0px; padding: 0px;">
