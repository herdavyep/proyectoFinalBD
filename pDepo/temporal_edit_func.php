...
function art_form_updatedata_display($form, $message){
    ...
    art_sitemenu_display("temporal_edit", "defaulttheme");
    print "</td>\n";
    ...
    print "<td width=\"3\" class=\"formColumnData\">&nbsp;</td>\n";
    print "<td class=\"formColumnData\" align=\"left\">\n";
    print "<input class=\"textbox\" id=\"compra_id\" name=\"compra_id\" type=\"text\" value=\"" . $value . "\"  size=\"10\" maxlength=\"10\" >\n";
    print "</td>\n";
    print "</tr>\n";
...
function art_update_data(){
    ...
    if (($result == "") && (art_session('art_form_loaded', 0) != 1)){
        ...
        $sql .= " temporal.compra_id = " .  art_quote_intval($artv_compra_id); 
        $sql .= ",temporal.fecha_creacion = " .  art_quote_dateval($artv_fecha_creacion); 
        $sql .= " WHERE ";
        $sql .= " temporal.compra_id = " .  art_quote_intval($artv_pm_compra_id);
        $sql .= " AND  temporal.id = " .  art_quote_intval($artv_pm_id);
    }
